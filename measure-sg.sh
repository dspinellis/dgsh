...
|} gather |{
	echo "$FNAMELEN:$NSTRUCT:$NTYPEDEF:$IDLEN:$CHLINESCHAR:$NCCHAR:$NCOMMENT:$NCOPYRIGHT:$NCFILE:$NCDIR:$CLINESCHAR:$NFUNCTION:$NGOTO:$NREGISTER:$NMACRO:$NINCLUDE:$NCONST:$NVOID:$NHFILE:$NGETS"
|}
