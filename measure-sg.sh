...
|} gather |{
	echo "$CODE:$DATE:$YSTEM:$FNAMELEN:$NSTRUCT:$NTYPEDEF:$IDLEN:$CHLINESCHAR:$NCCHAR:$NCOMMENT:$NCOPYRIGHT:$NCFILE:$NCDIR:$CLINESCHAR:$NFUNCTION:$NGOTO:$NREGISTER:$NMACRO:$NINCLUDE:$NCONST:$NVOID:$NHFILE"
|}
